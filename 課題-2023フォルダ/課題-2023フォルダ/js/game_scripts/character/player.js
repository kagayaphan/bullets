...
class Player extends Object2D {
    ...
    assignWeapon(selectedWeapon){
        ...
        if(selectedWeapon.level === 0) {
            hud_manager.setMessage(localize.error_not_available);
            return;
        }
        this._weapon = selectedWeapon;
        hud_manager.setMessage(localize.success_weapon_changed);
...
class Bullet extends Object2D {
    ...
    initShot(target){
        ...
        // Play sfx
        sound_manager.playSfx(this._sfx_init);
    }
    ...
    remove() {
        sound_manager.playSfx(this._sfx_hit);
        // this._sfx_hit = null;
        // this._sfx_init = null;
...
class NetBullet extends Bullet {
    constructor(sprite, scale, speed, range) {
        ...
        this._sfx_hit = null;
        this._sfx_init = sfx_sound.wp_net_init_shot;
    }
...
class BombBullet extends Bullet {
    constructor(sprite, scale, speed, range) {
        ...
        this._sfx_init = sfx_sound.wp_bomb_init_shot;
        this._sfx_hit = sfx_sound.wp_bomb_hit;
    }
